...
- [ ] **Phase 1: Environment Validation & Stock Baseline** - Validated WSL2 ROCm/HIP stack, pinned stock llama.cpp gfx1100 build, locked IQ4_XS artifact running fully on GPU
...
|-------|----------------|--------|-----------|
| 1. Environment Validation & Stock Baseline | 0/TBD | Not started | - |
