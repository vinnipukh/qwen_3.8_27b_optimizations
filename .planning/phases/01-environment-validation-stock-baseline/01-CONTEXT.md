...
- `.planning/reference/ROADMAP-original.md` — original methodology rules (binding, inherited via ROADMAP.md)
- `.planning/research/MODEL-DECISION.md` — locked artifact identity, sha256, VRAM envelope incl. DXG deficit
- `.planning/research/deep-research/REPORT.md` — validated platform assumptions; PROF-01 op-timer baseline decision; ≥b8394 lineage requirement
- `.planning/research/deep-research/raw/scrapes/06-amd-wsl-howto.md` — AMD's official ROCm-on-WSL install procedure (primary reference for D-03)
- `.planning/research/deep-research/raw/scrapes/07-librocdxg.md` — librocdxg quickstart + compatibility matrix
