...
- `.planning/ROADMAP.md` §Phase 5 — KERN-02, KERN-03 authoritative text and constraints.
- `.planning/REQUIREMENTS.md` — Authoritative requirements traceability.
...
- `.planning/reference/GPU-KERNEL-RESOURCES.md` — AMD RDNA3 ISA (70650), WMMA intrinsics, and GPUOpen tuning guides.
