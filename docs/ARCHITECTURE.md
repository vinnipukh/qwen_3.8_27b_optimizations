...
├── docs/research/freetoken-probe/           # early ROCm probe tooling
├── build_windows.bat               # Windows-native gfx1100 build (HIP_PATH-quoted, -G Ninja, :8000 smoke)
├── docs/                           # Documentation, ROADMAP.md, REQUIREMENTS.md, PROJECT-OVERVIEW.md,
│   ├── phases/                     # Phase context, plans, and verification summaries
│   ├── research/                   # Model decisions, architecture deep dives
│   └── reference/                  # Original roadmaps and GPU kernel resources
...
The pre-existing 18-phase methodology plan is preserved verbatim at `docs/reference/ROADMAP-original.md`; every retained element maps into the 7-phase structure via the Merge Map in `docs/ROADMAP.md` (v2-deferred: attention/KV autotuning, imatrix, stretch goals per REQUIREMENTS.md).