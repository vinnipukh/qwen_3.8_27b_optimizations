...
```acceptance-report
{
  ...
  "reviewFindings": [
    "blocker: none",
    "major: docs/ROADMAP.md Phase 3 states PR #7016 is 'newly shipped' but it is open/unmerged (https://github.com/ROCm/rocm-systems/pull/7016)",
    "major: docs/REQUIREMENTS.md PROF-01 labels itself 'Phase-1 exit criterion' while ROADMAP binds PROF-01 gate in Phase 3 - reconcile",
...
```acceptance-report
{
  "criteriaSatisfied": [
    {
      "id": "criterion-1",
      "status": "satisfied",
      "evidence": "Concrete findings delivered above with file paths (docs/research/deep-research/raw/scrapes/01-issue20651.md, 03-disc15021.md lines 87-121/2152/2693/2820-2869, EVIDENCE-INDEX.md, ROADMAP.md, REQUIREMENTS.md, MODEL-DECISION.md), corroborating URLs (llama.cpp issues #20651, #20934, #20354, #20218, #23244, PR #22673, aguyintech.com, reddit 1t72ul7), severity via verdicts (CONFIRMED/PARTIAL), and implications per phase (Phase 1 pin >=b8394, Phase 2/6 Vulkan comparator arm + GGML_HIP_GRAPHS=ON probe, BENCH-04 32k expected-fail path, v2 MTP VRAM budgeting)."
    }
  ],
  "changedFiles": [],
  "testsAddedOrUpdated": [],
  "commandsRun": [
    {
      "command": "read docs/research/deep-research/EVIDENCE-INDEX.md; read scrapes 01,02,03,10,11,12; grep targeted sections of 03-disc15021.md",
      "result": "passed",
...
```acceptance-report
{
  "criteriaSatisfied": [
    {
      "id": "criterion-1",
      "status": "satisfied",
      "evidence": "Four verdicts returned with file paths (docs/research/deep-research/raw/scrapes/08-chipsandcheese-rdna3.md, 09-gpuopen-wmma.md, 03-disc15021.md, docs/research/PITFALLS.md:134, STACK.md:28, ROADMAP.md Phase 4/5 risk notes) plus severity-tagged NEW-RISKS with primary-source URLs (hipBLASLt#831, rocm-libraries#7026, seb-v writeup, llama.cpp PR #23349, source-verified mul_mat dispatch)"
    }
  ],
  "changedFiles": [],
  "testsAddedOrUpdated": [],
  "commandsRun": [
    {
      "command": "grep/find over docs/research/** (EVIDENCE-INDEX, scrapes 03/08/09, PITFALLS/STACK/SUMMARY)",
      "result": "passed",
  ...
  "residualRisks": [
    ...
    "docs/research/PITFALLS.md Pitfall 7 references retired Phase 8/12 numbering (doc drift)"
  ],
  "noStagedFiles": true,
  ...
  "criteriaSatisfied": [
    {
      "id": "criterion-1",
      "status": "satisfied",
      "evidence": "5 roadmap bets adjudicated with concrete citations to docs/research/deep-research/raw/scrapes/ (01,03,04,05,07) plus 10 external URLs; severities carried via VERDICT labels and implications; all five assigned attack vectors covered"
    }
  ],
  "changedFiles": [],
  "testsAddedOrUpdated": [],
