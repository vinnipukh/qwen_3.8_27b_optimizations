...
(copy archived at `docs/tmp/hip-rocm-SKILL.md`).*
...
- Our internal `docs/research/deep-research/` corpus (12 targeted scrapes: hip-windows-
  guide, GPUOpen wmma, chipsandcheese RDNA3, librocdxg, rocm-limitations…) is strictly deeper
  and project-correct.
- Copy archived at `docs/tmp/hip-rocm-SKILL.md`; the common-problems table is the only
  mildly reusable bit.
