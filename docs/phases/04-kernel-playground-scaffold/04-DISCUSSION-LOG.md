...
**Triggered by:** owner flag to mine `@docs/reference/GPU-KERNEL-RESOURCES.md` (15 resources, §1–5) + re-verify `@docs/research/EXTERNAL-RESOURCES-ASSESSMENT.md` before drafting.
