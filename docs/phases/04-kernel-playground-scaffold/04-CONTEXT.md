...
**Deep research:** 6 parallel subagents + 8 direct fetches covering all 15 resources in `@docs/reference/GPU-KERNEL-RESOURCES.md` and re-verified `@docs/research/EXTERNAL-RESOURCES-ASSESSMENT.md`
...
- `docs/ROADMAP.md` §Phase 4 — KERN-01 success criteria, RDNA3 risk notes (warpSize templating), parallelization
- `docs/REQUIREMENTS.md` §Kernels & Integration — KERN-01 authoritative text
- `docs/STATE.md` — Phase 3 deliveries, Optimization Target #1 `MUL_MAT`, frozen env `bb4caa75` / ROCm 7.2.1 / `53adc4bb…`
...
- `docs/phases/03-correctness-gates-bottleneck-profiling/03-CONTEXT.md` — prior gate/profiler patterns
...
### External resource hubs (from @docs/reference/GPU-KERNEL-RESOURCES.md)
