...
- `docs/ROADMAP.md` — Phase 3 success criteria, WSL2 risk notes, binding methodology rules
- `docs/REQUIREMENTS.md` §Correctness & Profiling — QUAL-01, QUAL-02, PROF-01, PROF-02 authoritative text
- `docs/phases/02-benchmark-harness-baseline-matrix/02-CONTEXT.md` — Phase 2 established harness, store, guard, and telemetry infrastructure
