...
- Repo artifacts: `benchmarks/environment/{versions.txt,llamacpp-pin.txt,startup-log.txt,vram-probe.txt}`, `baseline/binaries/v0.2.0-bb4caa75/` (ELF; cmp-identical to build-ci), `docs/{ROADMAP,REQUIREMENTS,STATE}.md`, Phase-1 CONTEXT/SUMMARY, deep-research REPORT.md, `.claude/CLAUDE.md`
