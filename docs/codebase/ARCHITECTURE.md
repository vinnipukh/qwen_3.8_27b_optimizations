...
**What happens:** earlier `bench_gemm_wmma.cpp` documented 5 variants (`64x32_P2+33` … `LUT_mu4`) and `--variant race`, but all mapped to the single P=2 64×32 compiled kernel — racing compared identical code (see `docs/research/P8_VARIANT_COMPILE_PROPOSAL.md`).
